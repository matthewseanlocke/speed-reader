...
- Version: v4.28 (pinned to bottom of screen on all views)
...
### Text / Content
- Default text: random from `textGrabBag` on first load
- Includes: Pale Blue Dot, The Road Not Taken, I Have a Dream, Gettysburg Address, Hamlet
